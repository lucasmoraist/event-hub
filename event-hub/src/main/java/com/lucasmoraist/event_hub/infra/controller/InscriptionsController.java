...
public interface InscriptionsController {
    ...
    ResponseEntity<InscriptionResponse> subscribe(@PathVariable UUID userId, @PathVariable UUID eventId);
    ...
    ResponseEntity<InscriptionResponse> confirm(@PathVariable UUID inscriptionId);
    ...
    ResponseEntity<InscriptionResponse> cancel(@PathVariable UUID inscriptionId);
    ...
    ResponseEntity<List<InscriptionResponse>> findByUserId(@PathVariable UUID userId);
    ...
    ResponseEntity<List<InscriptionResponse>> findByEventId(@PathVariable UUID eventId);
    ...
    ResponseEntity<List<InscriptionResponse>> listWaitingList(@PathVariable UUID eventId);
    ...
    ResponseEntity<Void> checkIn(@PathVariable UUID inscriptionId);
